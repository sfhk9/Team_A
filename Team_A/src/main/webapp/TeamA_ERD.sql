...
(
	...
	-- 상품 설명용 이미지
	goodsimg varchar2(300) NOT NULL UNIQUE,
	hits number default '0' NOT NULL,
	PRIMARY KEY (unq)
);
...
COMMENT ON COLUMN cart.goodsunq IS '상품 테이블의 g_unq';
...
1 : 신발';
COMMENT ON COLUMN goodsinfo.ctgtype IS '0 : 스포츠
1 : 레저
2 : 일상';
COMMENT ON COLUMN goodsinfo.ctggender IS 'N : 무관
M : 남성용
F : 여성용';
COMMENT ON COLUMN goodsinfo.thumbnail IS '썸네일';
COMMENT ON COLUMN goodsinfo.goodsimg IS '상품 설명용 이미지';
