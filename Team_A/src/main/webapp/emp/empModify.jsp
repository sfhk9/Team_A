		...
		<div style="width:400px; padding-top:20px; margin:0 auto;">
			...
			<table>
			   ...
			   <tr>
			      <th>사원이름</th> 
			      <td>
					<input type="text" name="ename" id="ename" class="ename1" value="${vo.ename }">
				  </td>
			   </tr>
			   <tr>
			      <th>급여</th> <!-- 숫자여부 -->
			...
			<input type="text" name="sal" value="<fmt:parseNumber value="${vo.sal }"/>"> <br>
			...
			<fmt:formatNumber maxFractionDigits="3" value="${vo.sal }"/>
			   ...
			   <tr>
			      ...
			      <td>
					  ...
					  <input type="text" name="hiredate" id="hiredate" value="${mm}/${dd}/${yy}" >
			      </td>
			   </tr>
			   <tr>
			      <th colspan="2">
